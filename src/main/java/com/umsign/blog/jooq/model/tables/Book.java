...
public class Book extends TableImpl<BookRecord> {
    ...
    private static final long serialVersionUID = -1876430564;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BOOK_FK_BOOK_AUTHOR_IDX, Indexes.BOOK_FK_BOOK_LANGUAGE_IDX, Indexes.BOOK_PRIMARY);
    }
