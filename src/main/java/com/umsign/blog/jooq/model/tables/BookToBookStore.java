...
public class BookToBookStore extends TableImpl<BookToBookStoreRecord> {
    ...
    private static final long serialVersionUID = 1779959801;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BOOK_TO_BOOK_STORE_FK_B2BS_BOOK_IDX, Indexes.BOOK_TO_BOOK_STORE_PRIMARY);
    }
